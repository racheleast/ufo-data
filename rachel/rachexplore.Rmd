...
##### As we can see from the map, we have a lot of sightings. We are going to look at the relationship between the year and the number of sightings to help us determine a place to split the data. We believe a dichotomous data set will be more useful in our anaylsis.  
...
##### I tried to plot everything on one graph, but it didn't turn out great because sightings are in the hundreds and population is in the millions. I have decided to scale down population by 10,000 so we can see both variables in one graph.
...
perstate1$Population <- perstate1$Population / 10000
